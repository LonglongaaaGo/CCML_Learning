...
def get_args():
    ...
    parser.add_argument('--dataset-mode', type=str, default="vehicle_logo", help='dataset, (default: vehicle_logo)')

    parser.add_argument('--use_val', type=bool, default=False, help='use the val dataset(default: True)')
    parser.add_argument('--filename', type=str, default="vehicle_logo_1", help='dataset, (default: vehicle_logo_1)')
    ...
    parser.add_argument('--num_classes', type=int, default=100, help='batch size, (default: 100)')
...
def train_HFUT_V1(args = None):
    if args == None: args = get_args()
    ...
    args.modelName = "VLF_net"
    args.batch_size = 128
    args.size = "64,64"
    args.crop = "64,64"    #be used for training
    args.epochs = 150
    args.debug = False
...
def train_HFUT_V2(args=None):
    ...
    args.size = "112,112"
    #height, width
    args.crop = "112,112"  #be used for training
    args.epochs = 150
    args.debug = False
...
def train_XMU(args=None):
    ...
    args.batch_size = 128
    args.size = "70,70"
    args.crop = "70,70" #be used for training
    args.epochs = 150
    args.debug = False
...
def train_CompCar(args=None):
    ...
    args.batch_size = 32
    args.size = "256,256"
    args.crop = "224,224" #be used for training
    args.epochs = 150
    args.debug = False
...
def train_VLD_45B(args=None):
    ...
    args.batch_size = 8
    args.size = "512,512"
    args.crop = "512,512"  #be used for training
    args.epochs = 150
    args.debug = False
...
def ccml_train_HFUT_V1(args=None):

    if args == None: args = get_args()
    args.framework = "CCML_Network"
    args.dataset_mode = "CCML_vehicle_logo"

    args.ccml_loss_weight = 0.01

    args.num_classes = 80
    args.train_Root = "/root/workspace/Data/HFUT-VL1_classify"
    args.modelName = "CCML_VLF_net"
    args.batch_size = 128
    args.size = "64,64"
    args.crop = "64,64" #be used for training
    args.epochs = 150
...
def ccml_train_HFUT_V2(args=None):
...
def ccml_train_VLD_45B(args=None):
...
def ccml_train_CompCar(args=None):
    if args == None: args = get_args()
